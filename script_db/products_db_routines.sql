...
BEGIN
	insert into orderm (id, username, product_id, quantity, date) values (_id, _username, _product_id, _quantity, _date);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	insert into product (id, name, category, price, url) values (_id, _name, _category, _price, _url);
    insert into history (type, product_id, name, date) values ('add', _id, _name, _date);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `add_stock`(
	in _product_id varchar(10),
    in _num int
)
BEGIN
	declare _name varchar(100) default (select name from product where product.id = _product_id);
	while _num > 0 do
		insert into stock (product_id, name) value (_product_id, _name);
		set _num = _num - 1;
    end while;
END ;;
DELIMITER ;
...
BEGIN
	insert into user (id, email, password) values (_id, _email, _pass);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	delete from category where categories.name = _name;
    delete from product where products.category = _name;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    ...
    delete
    from stock
    where stock.product_id = _id;
    insert into history (type, product_id, date) values ('delete', _id, _date);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	delete from stock where stock.id = _id;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    ...
    set p.price = _price
    where p.id = _id;
    insert into history (type, product_id, date) values ('edit', _id, _date);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_history`(in _type varchar(10))
BEGIN
	select *
    from history_product
    where history.type = _type;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
